...
function Carousel.new(direction: "X" | "Y")
    ...
    function carousel:Mount(parent: GuiObject, hideParent: boolean?)
        ...
        if IS_PLAYING then
            ...
            list.CanvasSize = UDimUtil.scalarMultiplyUDim2(canvasSize, 1 / UIScaleController.getScale())
            carousel:GetMaid():GiveTask(UIScaleController.ViewportSizeChanged:Connect(function()
